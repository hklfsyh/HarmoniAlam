// Tipe data Event, disamakan dengan EventCard
interface Event {
  event_id: number;
  title: string;
  description: string;
...
const fetchEvents = async (searchTerm: string, categoryId: number | null): Promise<Event[]> => {
...
const EventList: React.FC<EventListProps> = ({ searchTerm, selectedCategory, onSuccess, onFailure }) => {
      ...
      {events && (
        events.length > 0 ? (
          ...
          <div className="text-center py-12">
            <h3 className="text-xl font-semibold text-gray-700">Tidak Ada Event yang Ditemukan</h3>
