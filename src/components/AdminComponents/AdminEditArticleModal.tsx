// src/components/AdminComponents/AdminEditArticleModal.tsx
...
const AdminEditArticleModal: React.FC<AdminEditArticleModalProps> = ({ isOpen, onClose }) => {
        ...
        <div className="fixed inset-0  bg-opacity-50 flex justify-center items-center z-50 p-4" style={{ backdropFilter: 'blur(4px)', WebkitBackdropFilter: 'blur(4px)' }}>
            <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
                ...
                <form className="space-y-6">
                    ...
                    <FormField label="Ringkasan Artikel" value="Perubahan iklim telah menjadi salah satu tantangan terbesar yang dihadapi ekosistem pantai Jakarta." multiline />
                    <FormField label="Konten Artikel" value="Kenaikan permukaan air laut, perubahan pola curah hujan, dan meningkatnya suhu global memberikan dampak signifikan..." multiline rows={8} />
