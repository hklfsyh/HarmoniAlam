    ...
    <div className="container mx-auto px-4 sm:px-6 my-6 sm:my-8">
      ...
      <div className="relative mb-4 sm:mb-6">
        ...
        <input
          ...
          className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg shadow-sm text-sm sm:text-base focus:ring-2 focus:ring-[#79B829] focus:border-transparent"
        />
      </div>
